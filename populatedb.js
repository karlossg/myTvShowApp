...
function creatorCreate(first_name, family_name, d_birth, d_death, cb) {
  creatordetail = { first_name: first_name, family_name: family_name }
...
function showCreate(title, summary, isbn, author, genre, cb) {
  bookdetail = {
    title: title,
    summary: summary,
    author: author,
